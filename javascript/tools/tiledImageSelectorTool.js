...
var tiledImageSelectorTool = new Class ({
   ...
   initialize: function(params) {
      ...
      //console.log("enter tiledImageSelectorTool.initialize: ",params);
     ...
     this.wlzToStackOffset = this.model.getWlzToStackOffset();
      ...
      this.window = new DraggableWindow({targetId:this.targetId,
					 ...
					 initiator:this});
      //console.log("tiledImageSelectorTool: x %s, y %s",params.params.x, params.params.y);
   ...
   doMouseUp: function(e) {
	 ...
	 //console.log("tiledImageSelectorTool: %s doMouseUp",klass);
	 this.view.updateDst();
      } else {
	 //console.log("tiledImageSelectorTool: doMouseUp on unkown target ",klass);
      }
