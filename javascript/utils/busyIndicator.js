...
emouseatlas.emap.busyIndicator = function() {
   ...
   var buildBusyIndicator  = function () {
	 ...
	 busyIndicatorContainer.id = "busyIndicatorContainer";
      ...
      busyIndicatorImage = document.createElement("img");
      busyIndicatorImage.id = "busyIndicatorImage";
      ...
      busyIndicatorImageDiv.appendChild(busyIndicatorImage);
	 ...
	 //console.log("added buildBusyIndicator");
      }
