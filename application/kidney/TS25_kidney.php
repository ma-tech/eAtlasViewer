...
<script type="text/javascript">
   function doOnload() {
      jso = { "modelDataUrl":"/eAtlasViewer_dev/application/kidney/TS25_kidney/tiledImageModelData.jso" };
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" media="all" href="/eAtlasViewer_dev/application/kidney/project.css" />
   ...
   <body onload=doOnload();
	 ...
	 <div id="pageHeaderDiv" class="ema_wlz">
	    ...
	    <div id="wlzIIPViewerTitle">
               3D Model of Kidney (EMA:103): TS25(17.5 dpc)
            </div>
	 </div>
