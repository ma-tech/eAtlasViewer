...
<script type="text/javascript">
   function doOnload() {
      jso = {"modelDataUrl":"/eAtlasViewer_dev/application/chick/HH26/tiledImageModelData.jso"};
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" media="all" href="/eAtlasViewer_dev/application/chick/project.css" />
   ...
   <body onload=doOnload();
	 ...
	 <div id="logoContainer">
	    ...
	    <div id="wlzIIPViewerTitle">
               Electronic Atlas of the Chick HH26
	    </div>
	 </div>
