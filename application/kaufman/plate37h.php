...
<script type="text/javascript">
   function doOnload() {
      jso = {"modelDataUrl":"/eAtlasViewer_dev/application/kaufman/plate37h/tiledImageModelData.jso",
   ...
   <body onload=doOnload();
	 ...
	 <div id="pageHeaderDiv">
	    ...
	    <div id="wlzIIPViewerTitle">
               Plate 37h (16.5 days p.c. Theiler stage 25) from 'The Atlas of Mouse Development' by Matt Kaufman
            </div>
	 </div>
