...
<script type="text/javascript">
   function doOnload() {
      jso = {"modelDataUrl":"/eAtlasViewer_dev/application/kaufman/plate36e/tiledImageModelData.jso",
   ...
   <body onload=doOnload();
	 ...
	 <div id="pageHeaderDiv">
	    ...
	    <div id="wlzIIPViewerTitle">
               Plate 36e (15.5 days p.c. Theiler stage 24) from 'The Atlas of Mouse Development' by Matt Kaufman
            </div>
	 </div>
