...
<script type="text/javascript">
   function doOnload() {
      jso = {"modelDataUrl":"/eAtlasViewer_dev/application/kaufman/plate34a/tiledImageModelData.jso",
   ...
   <body onload=doOnload();
	 ...
	 <div id="pageHeaderDiv" class="multiple">
	    ...
	    <div id="wlzIIPViewerTitle">
               Plate 34a (14.5 days p.c. Theiler stages 22-23) from 'The Atlas of Mouse Development' by Matt Kaufman
            </div>
	 </div>
