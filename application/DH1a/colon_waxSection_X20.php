...
?>
      ...
      <script type="text/javascript"> 
         function doOnload() { 
         jso = { "modelDataUrl":"/eAtlasViewer_dev/application/DH1a/colon_waxSection_X20/tiledImageModelData.jso" }; 
      ...
      <link rel="stylesheet" type="text/css" media="all" href="/eAtlasViewer_dev/application/DH1a/project.css" />
      ...
      <link rel="stylesheet" type="text/css" media="all" href="/eAtlasViewer_dev/css/tools/queryAnatomy.css" />
      ...
      <script type="text/javascript" src="/eAtlasViewer_dev/javascript/tools/queryAnatomy.js"></script>
   ...
   <body onload=doOnload();
	 ...
	 <div id="pageHeaderDiv">
	    <div id="wlzIIPViewerTitle">
               colon wax section X20
            </div>
	 </div>

	 <div id="toolContainerDiv" class="HR">
	    <div id="contextMenuHintDiv" class="HR">
	 ...
	 <center>      
	    ...
	    <div id="emapIIPViewerDiv" class="HR" ></div>
	 </center>
