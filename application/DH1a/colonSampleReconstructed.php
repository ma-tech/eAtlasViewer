...
?>
      ...
      <script type="text/javascript"> 
         function doOnload() { 
         jso = { "modelDataUrl":"/eAtlasViewer_dev/application/DH1a/colonSampleReconstructed/tiledImageModelData.jso" }; 
   ...
   <body onload=doOnload();
	 ...
	 <center>      
	    ...
	    <div id="emapIIPViewerDiv" class="anatomy" ></div>
	 </center>
