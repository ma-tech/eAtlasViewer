...
<script type="text/javascript">
   function doOnload() {
      jso = {"modelDataUrl":"/eAtlasViewer_dev/application/hudsen/CS17/tiledImageModelData.jso"};
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" media="all" href="/eAtlasViewer_dev/application/hudsen/project.css" />
      ...
      <script type="text/javascript" src="/eAtlasViewer_dev/javascript/tools/tiledImageOpacityTool.js"></script>
   ...
   <body onload=doOnload();
	 ...
	 <div id="logoContainer">
	    <img src="/eAtlasViewer_dev/images/ema_logo_transparent_70.png"></img>
         ...
         <div id="wlzIIPViewerIFrameContainer" class="wlzIIPViewerIFrameContainer">
            ...
            <iframe id="wlzIIPViewerIFrame" class="wlzIIPViewerIFrame" src="/eAtlasViewer_dev/html/helpFrame_3D.html" name="wlzIIPViewerIFrame" scrolling="no">
            </iframe>
         </div>
	    ...
	    <div id="wlzIIPViewerTitle">
               Electronic Atlas of the Developing Human Brain CS17
	       <div id="wlzIIPViewerTitleLink">
                  <a href="http://www.hudsen.org/" target="_blank"><img src="/eAtlasViewer_dev/application/hudsen/hudsenLogo_25.png"></a>
	       </div>
	    </div>
	 </div>
	 ...
	 <div id="toolContainerDiv">
            <div id="contextMenuHintDiv">
               Right-click over main image for context menu & more options
            </div>
         </div>
