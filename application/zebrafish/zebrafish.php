...
?>
      ...
      <script type="text/javascript"> 
         function doOnload() { 
         jso = { "modelDataUrl":"../../application/zebrafish/zebrafish/tiledImageModelData.jso" }; 
      ...
      <link rel="stylesheet" type="text/css" media="all" href="../../application/zebrafish/project.css" />
      ...
      <div id="projectDiv">
         ...
         <div id="pageHeaderDiv" class="">
            <div id="wlzIIPViewerTitle">
               Juvenile zebrafish - 2011-10-sam29-33-10mmJuvenile-wt-pta, <a href="http://zfatlas.psu.edu/microct.php" target="_blank"> Zebrafish Atlas </a>
            </div>
         </div>
