...
<script type="text/javascript">
   function doOnload() {
      jso = { "modelDataUrl":"/eAtlasViewer_dev/application/ABA/tiledImageModelData.jso" };
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" media="all" href="/eAtlasViewer_dev/application/ABA/project.css" />
   ...
   <body onload=doOnload();
	 ...
	 <div id="pageHeaderDiv" class="ema_wlz">
	    <div id="wlzIIPViewerTitle">
               <a href="http://www.brain-map.org/" target="_blank">ALLEN BRAIN ATLAS </a>  overlay and labels
            </div>
	 </div>
