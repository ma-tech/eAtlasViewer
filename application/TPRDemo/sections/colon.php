...
<script type="text/javascript">
   function doOnload() {
      jso = {
         "modelDataUrl":"/eAtlasViewer_dev/application/TPRDemo/sections/colon/tiledImageModelData.jso",
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" media="all" href="/eAtlasViewer_dev/application/TPRDemo/sections/project.css" />
   ...
   <body onload=doOnload();
	 ...
	 <div id="pageHeaderDiv" class="ema_sections">
